...
# Courbe pour comparer le nombre de primitives analysées
plt.figure(figsize=(10, 6))
plt.plot(pan_labels, num_features_fixed, label='Classical-CBR Approach', c='skyblue', marker='o', linestyle='-', linewidth=2)
plt.plot(pan_labels, num_features_variable, label='PH-CBR Approach', c='orange', marker='o', linestyle='-', linewidth=2)
plt.xlabel('Failures', fontsize=14)
plt.ylabel('Number of observed features', fontsize=14)
plt.ylim(0, 30)  # Modifier l'échelle de l'axe des y
